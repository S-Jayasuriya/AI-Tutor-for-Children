...
function GamifyApp() {
        ...
        useEffect(() => {
            if (messages.length > 0) {
                messages.forEach((msg, index) => {
                    if (msg.role === 'assistant' && !msg.isVideo) {
    ...
    const sendMessage = async () => {
        ...
        if (input.startsWith("video-") ) {
            ...
            endpoint = 'http://localhost:5000/llama_chat';
    ...
    try {
            ...
            if (input.startsWith("video-") || input.startsWith("youtube-")) {
                ...
                console.log(answer);
                var aiMessage = { role: 'assistant', content: data.answer };
...
const startVoiceInput = () => {
    ...
    const replaceAsterisksWithBold = (text) => {
        // Remove <|start_header_id|> ... <|end_header_id|> and "center assistant"
        text = text.replace(/<\|start_header_id\|>.*?<\|end_header_id\|>/g, '');
        text = text.replace(/center assistant/gi, ''); // Case-insensitive removal of "center assistant"
    ...
    <header className="header" style={{ zIndex: 9999 }}>
                <nav className="nav">
                    ...
                    <ul className="nav_items">
                        <li className="nav_item">
                            ...
                            <a href="#" className="nav_link" style={{ color: 'black' }}>Gamify</a>
        ...
        <div className="chat-container">
            ...
            <div className="language-dropdown">
                ...
                <h2 className="headings">Gamify</h2>
            </div>
            <div className="messages1">
                {messages.map((msg, index) => (
                    <div key={index}>
                        ...
                        {msg.role === 'assistant' && !msg.isVideo && (
                            <>
